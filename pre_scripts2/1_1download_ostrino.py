...
from_datetime = datetime.datetime(2023, 10, 1, 0, 0, 0)  # Adjust as needed
to_datetime = datetime.datetime(2024, 4, 30, 0, 0, 0)    # Adjust as needed

# Create the summer23 folder
os.makedirs('winter23', exist_ok=True)

# Inside summer23 folder, create a raw folder
os.makedirs('winter23/raw', exist_ok=True)
